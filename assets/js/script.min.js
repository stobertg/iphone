...
!function(n,e){e(function(){e("#menu").slicknav({label:"",closeOnClick:!0}),e("#filters").slicknav({label:"Filter Collection",prependTo:".filter-container",closeOnClick:!0}),e(".slicknav_nav a").click(function(){var n=e(this).text();e(".filter-container .slicknav_menutxt").text(n)})}),e(function(){var n=Modernizr.testProp("backgroundBlendMode");n===!1&&e("html").addClass("no-background-blendmode")}),e(document).foundation(),e(document).foundation("reveal",{animation:"fade"}),e(function(){FastClick.attach(document.body)}),e(function(){var o=n.location.hash?"."+n.location.hash.substr(1):"all";e("#Container").mixItUp({animation:{duration:400,effects:"fade",easing:"ease"},layout:{display:"block"},load:{filter:o}})}),e(function(){e(".center").slick({centerMode:!0,centerPadding:"60px",arrows:!0,slidesToShow:3,dots:!0,responsive:[{breakpoint:1024,settings:{arrows:!1,centerMode:!0,centerPadding:"40px",slidesToShow:3}},{breakpoint:768,settings:{arrows:!1,centerMode:!0,centerPadding:"40px",slidesToShow:3}},{breakpoint:480,settings:{arrows:!1,centerMode:!0,centerPadding:"40px",slidesToShow:1}}]})})}(window,jQuery);
